...
<div className='container flex_space'>
    ...
    <ul className={click ? "nav-menu active" : "nav-menu"}>
           ...
           <li><Link to='/testimonial' onClick={closeMobileMenu}>The Team</Link></li>
  ...
  <header>
    <div className="container flex_space">
        <div className="logo">
            <img src="images/logo.png" height={100} width={300} alt=""/>
    </div>
    <div className="contact flex_space">
        ...
        <div className="box flex_space">
            ...
            <div className="text">
                <h4>Call Us</h4>
                <Link to="/contact">+1 (800) 344-3355</Link>
            </div>
        </div>
        <div className="box flex_space">
            <div className="icons">
            ...
            <div className="text">
                <h4>Mail Us</h4>
                <Link to="/contact">info.csun.69@my.csun.edu</Link>
            </div>
        </div>
    </div>
</div>
